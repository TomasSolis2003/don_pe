...
public class AnimalIA : MonoBehaviour, IDañoRecibible
{
    [Header("Referencias")]
    public Transform jugador;
    public GameObject itemDrop;
    ...
    {
        vida -= cantidad;
        Debug.Log($"[AnimalIA] {name} recibe daño: {cantidad}, vida ahora: {vida}");
    ...
    void Morir()
    {
        Debug.Log($"[AnimalIA] {name} ha muerto");
